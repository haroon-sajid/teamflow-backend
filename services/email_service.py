...
import urllib.parse  # ✅ new import for safe links
...
class EmailService:
    ...
    async def send_invitation_email(
        ...
        # Ensure token in link is URL-safe
        invitation_link = urllib.parse.quote(invitation_link, safe=':/?=&')  # ✅ safe chars not encoded
